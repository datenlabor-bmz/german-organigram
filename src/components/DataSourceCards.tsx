...
const dataSources = [
  {
    ...
    links: [
      {
        label: 'Datenbank',
        url: 'https://www.service.bund.de/Content/DE/Behoerden/Suche/Formular.html?view=processForm&nn=9465610'
      },
      {
        label: 'Datensatz (JSON)',
        url: 'https://www.govdata.de/suche/daten/anschriftenverzeichnis-des-bundes'
      }
    ]
  },
  {
    title: 'Wikidata',
    description:
      'Strukturierte Daten über Behörden, Minister und Organisationsstrukturen',
    icon: Link2,
  ...
  },
  {
    ...
    links: [
      {
        label: 'WD-3-118-24',
        url: 'https://www.bundestag.de/resource/blob/1034204/WD-3-118-24-pdf.pdf'
      },
      {
        label: 'BMI Beauftragte',
        url: 'https://www.bmi.bund.de/SharedDocs/downloads/DE/veroeffentlichungen/themen/ministerium/liste-beauftragte-bundesregierung.pdf?__blob=publicationFile&v=18'
      },
      {
        label: 'WD-3-069-24',
        url: 'https://www.bundestag.de/resource/blob/1022330/372951946501ba20601a653d7b7fd614/WD-3-069-24-WD-4-050-24-pdf.pdf'
      }
    ]
  },
  {
